...
namespace SVPresentation.Formularios
{
    public partial class frmNegocio : Form
    {
        ...
        Negocio _negocio = new Negocio();                            //Variable local para acceder a los metodos dentro del formulario(Obtener y Eliminar)
            ...
            if (_openFileDialog.FileName != "")
            {
                ...
                if (cloudinaryResponse.PublicId != "")
                {
                    if (_negocio.NombreLogo != "")
                        await _cloudinaryService.EliminarImagen(_negocio.NombreLogo); //Se obtiene los metodos de negocio por ser una variable publica
