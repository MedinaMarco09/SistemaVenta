...
namespace SVPresentation.Formularios
{
    public partial class frmVenta : Form
    {
        ...
        public frmVenta(IProductoService productoService, IVentaService ventaService
            , IServiceProvider serviceProvider, INegocioService negocioService)
        {
            InitializeComponent();
        ...
        private async void btnRegistrar_Click(object sender, EventArgs e)  //Logica del PDF
        {
